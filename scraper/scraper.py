...
CITIES = {
    ...
    "osijek": {
        ...
        "date_selector": "time.tribe-events-calendar-list__event-datetime-wrapper",
    ...
    "pula": {
        ...
        "date_selector": ".color-caption p:nth-of-type(3)",
